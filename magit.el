...
(defvar magit-mode-map
  (let ((map (make-keymap)))
    ...
    (define-key map "\C-i" 'magit-toggle-section)
    ...
    (define-key map "?" 'magit-describe-item)
    (define-key map "!" 'magit-key-mode-popup-running)
    (define-key map ":" 'magit-git-command)
    (define-key map "\C-x4a" 'magit-add-change-log-entry-other-window)
    (define-key map "\C-m" 'magit-visit-item)
    (define-key map " " 'magit-show-item-or-scroll-up)
    (define-key map "\d" 'magit-show-item-or-scroll-down)
    (define-key map "\C-w" 'magit-copy-item-as-kill)
    (define-key map "R" 'magit-rebase-step)
    (define-key map "t" 'magit-key-mode-popup-tagging)
    (define-key map "r" 'magit-key-mode-popup-rewriting)
    (define-key map "P" 'magit-key-mode-popup-pushing)
    (define-key map "f" 'magit-key-mode-popup-fetching)
    (define-key map "b" 'magit-key-mode-popup-branching)
    (define-key map "B" 'magit-key-mode-popup-bisecting)
    (define-key map "F" 'magit-key-mode-popup-pulling)
    (define-key map "l" 'magit-key-mode-popup-logging)
    (define-key map "$" 'magit-display-process)
    (define-key map "c" 'magit-log-edit)
    (define-key map "E" 'magit-interactive-rebase)
...
(defvar magit-commit-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map "\C-c\C-b" 'magit-show-commit-backward)
    (define-key map "\C-c\C-f" 'magit-show-commit-forward)
    map))

(defvar magit-status-mode-map
  (let ((map (make-sparse-keymap)))
    (define-key map "-" 'magit-diff-smaller-hunks)
    (define-key map "+" 'magit-diff-larger-hunks)
    (define-key map "0" 'magit-diff-default-hunks)
    ...
    (define-key map "d" 'magit-diff-working-tree)
    (define-key map "D" 'magit-diff)
    (define-key map "a" 'magit-apply-item)
    (define-key map "A" 'magit-cherry-pick-item)
    (define-key map "v" 'magit-revert-item)
    (define-key map "b" 'magit-key-mode-popup-branching)
    (define-key map "m" 'magit-key-mode-popup-merging)
    (define-key map "M" 'magit-key-mode-popup-submodule)
    (define-key map "k" 'magit-discard-item)
    (define-key map "C" 'magit-add-log)
    (define-key map "x" 'magit-reset-head)
    (define-key map "X" 'magit-reset-working-tree)
    (define-key map "z" 'magit-key-mode-popup-stashing)
    map))
...
(defvar magit-log-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (define-key map "m" 'magit-key-mode-popup-merging)
    (define-key map "x" 'magit-reset-head)
    (define-key map "e" 'magit-log-show-more-entries)
    (define-key map "l" 'magit-key-mode-popup-logging)
    (define-key map "t" 'magit-key-mode-popup-tagging)
    map))
...
(defvar magit-show-branches-mode-map
  (let ((map (make-sparse-keymap)))
    (define-key map "k" 'magit-remove-branch)
    (define-key map "K" 'magit-remove-branch-in-remote-repo)
    (define-key map "v" 'magit-show-branches)
...
(defvar magit-log-edit-mode-map
  (let ((map (make-sparse-keymap)))
    (define-key map "\C-c\C-c" 'magit-log-edit-commit)
    (define-key map "\C-x#" 'magit-log-edit-commit)
    (define-key map "\C-c\C-a" 'magit-log-edit-toggle-amending)
    (define-key map "\C-c\C-s" 'magit-log-edit-toggle-signoff)
    (define-key map "\C-c\C-e" 'magit-log-edit-toggle-allow-empty)
    (define-key map (kbd "M-p") 'log-edit-previous-comment)
    (define-key map (kbd "M-n") 'log-edit-next-comment)
    (define-key map "\C-c\C-k" 'magit-log-edit-cancel-log-message)
    (define-key map "\C-c\C-]" 'magit-log-edit-cancel-log-message)
    (define-key map "\C-x\C-s" (lambda ()
                                (interactive)
